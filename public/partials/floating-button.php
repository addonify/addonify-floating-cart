<?php
?>
<button id="adfy__woofc-trigger" class="adfy__show-woofc <?php echo esc_attr( $position ); ?>" data_display="visible" data_animation="shake" data_style="rounded" data_label="false" data_icon="true">
	<span class="icon">
