...
<footer class="adfy__woofc-colophon <?php echo ( WC()->cart->get_cart_contents_count() > 0 ) ? '' : 'adfy__woofc-hidden' ?>" >
    ...
    <div class="adfy__woofc-coupon">
        <p class="coupon-text">
            ...
            <?php  echo esc_html( apply_filters( 'addonify-floating-cart-have-a-coupon-label', __('Have a coupon?','addonify-floating-cart')));  ?>
            <a href="#" id="adfy__woofc-coupon-trigger" class="adfy__woofc-link has-underline">
                <?php echo esc_html( apply_filters( 'addonify-floating-cart-click-to-apply-button-label', __('Click here to apply','addonify-floating-cart'))); ?>
            </a>
        </p>
    </div>
    <?php } ?>
