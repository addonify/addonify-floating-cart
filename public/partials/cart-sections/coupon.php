...
<div id="adfy__woofc-coupon-container" data_display="hidden">
	<div class="coupon-container-header">
		<button class="adfy__woofc-fake-button" id="adfy__woofc-hide-coupon-container">
			...
			<?php echo esc_html( $cart_strings['coupon_shipping_form_modal_exit_label'] ); ?>
		</button>
	</div>
	<form id="adfy__woofc-coupon-form">
		...
		<div class="adfy__woofc-coupon-inputs">
			...
			<input
				...
				placeholder="<?php echo esc_attr( $cart_strings['coupon_field_placeholder'] ); ?>"
			>
			<button type="submit" class="adfy__woofc-button" id="adfy__woofc-apply-coupon-button">
				<?php echo esc_html( $cart_strings['cart_apply_coupon_button_label'] ); ?>
			</button>
		</div>
	</form>
	<?php do_action( 'addonify_floating_cart_sidebar_cart_applied_coupons', $cart_strings ); ?>
</div>
<?php
