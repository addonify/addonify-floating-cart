...
<div id="adfy__woofc-coupon-container" data_display="hidden">
    <div class="coupon-container-header">
        <button class="adfy__woofc-fake-button" id="adfy__woofc-hide-coupon-container">
            ...
            <?php echo esc_html( apply_filters( 'addonify-floating-cart-go-back-label', __('Go back', 'addonify-floating-cart'))); ?>
        </button>
    </div>
    <form id="adfy__woofc-coupon-form">
        ...
        <div class="adfy__woofc-coupon-inputs">
            <label for="adfy__woofc-coupon-input-field">
                <?php echo esc_html( apply_filters( 'addonify-floating-cart-coupon-code-apply-label', __('If you have a coupon code, please apply it below.', 'addonify-floating-cart'))); ?>
            </label>
