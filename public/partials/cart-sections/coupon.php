...
<div id="adfy__woofc-coupon-container" data_display="hidden">
    <div class="coupon-container-header">
        <button class="adfy__woofc-fake-button" id="adfy__woofc-hide-coupon-container">
            ...
            <?php esc_html_e('Go back', 'addonify-floating-cart'); ?>
        </button>
    </div>
    <form id="adfy__woofc-coupon-form">
        ...
        <div class="adfy__woofc-coupon-inputs">
            <label for="adfy__woofc-coupon-input-field">
                <?php echo esc_html__('If you have a coupon code, please apply it below.', 'addonify-floating-cart'); ?>
            </label>
            <input type="text" value="" name="adfy__woofc-coupon-input-field" placeholder="<?php esc_attr_e('BLACKFRIDAY', 'addonify-floating-cart'); ?>">
